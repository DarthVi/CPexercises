...
def gc_model_sat(instance, avl_colors):
    
    n_nodes, edges = utils.load_instance(instance)
    solver = pywrapcp.Solver('gc_model_sat')
...
if __name__ == '__main__':
    ...
    gc_model_sat(instance, avl_colors)
